...
public class ContractController {
   ...
   public String addcontractview(Model model,  @PageableDefault(size = 5, sort = "id", direction = Sort.Direction.DESC) Pageable pageable) {
    ...
    @PostMapping("/saveContract")
       public String saveContract(
         ...
         /* contract.setContractSaveName(contractFile); */
           ...
           if(!contractRepository.existsByItem(contract.getItem())) { //1:1 관계
